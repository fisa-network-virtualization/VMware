...
<img width="1666" height="843" alt="image" src="https://github.com/user-attachments/assets/a84d2129-2c3b-4d17-8532-b55be3a57881" />

- Storage → Create Pool
  - 하드디스크가 1개 → Stripe Layout, 2개 → Mirror
    <img width="1671" height="829" alt="image" src="https://github.com/user-attachments/assets/e8b4aa54-93d6-4642-83ab-e72c3537f591" />


**② NFS 공유 활성화 및 권한 설정**
<img width="1397" height="847" alt="image" src="https://github.com/user-attachments/assets/4ae43895-abaa-4174-bdfe-d7e169d8bd97" />

- Shares → UNIX Shares → Add
  <img width="1394" height="842" alt="image" src="https://github.com/user-attachments/assets/535bddd5-3d9f-4703-966c-e8e56829da9b" />

- 앞서 만든 데이터셋 경로 선택 (`/mnt/pool_name/web_data`)
- Authorized Networks → Storage-PG 서브넷 대역 입력 (`10.40.110.0`)
  <img width="514" height="838" alt="image" src="https://github.com/user-attachments/assets/b8e5ec97-4763-4b77-a8e6-a1013a944161" />
