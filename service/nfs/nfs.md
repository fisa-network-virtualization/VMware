...
* **중복 제거:** 여러 대의 웹 서버(Web Server)나 애플리케이션 서버가 동일한 데이터에 접근해야 할 때, 각 서버마다 데이터를 복사할 필요 없음
...
> 본 프로젝트에서는 TrueNAS를 활용하여 NFS를 구성하는 방식을 선택
...
<img width="800" alt="image" src="https://github.com/user-attachments/assets/a84d2129-2c3b-4d17-8532-b55be3a57881" />

> Storage > Create Pool 클릭하여 생성.
하드디스크가 1개 → Stripe Layout, 2개 → Mirror 선택

- 생성된 ZFS 데이터셋 (`web_data`)
<img width="800" alt="image" src="https://github.com/user-attachments/assets/e8b4aa54-93d6-4642-83ab-e72c3537f591" />

<br/>
<br/>

**② NFS 공유 활성화 및 권한 설정**
<img width="800" alt="nfs_activate" src="https://github.com/user-attachments/assets/63a063cf-e4ed-4842-9289-7333b8c426a5" />

- Shares > UNIX Shares > add 클릭
<table>
  <tr>
    <td><img src="https://github.com/user-attachments/assets/b625954e-34e1-4ba7-b42c-d6a11e8dbc74" width="600"></td>
    <td><img src="https://github.com/user-attachments/assets/b8e5ec97-4763-4b77-a8e6-a1013a944161" width="240"></td>
  </tr>
</table>

1. 앞서 만든 데이터셋 경로 선택 (`/mnt/pool_name/web_data`)
2. Authorized Networks > Storage-PG 서브넷 대역 입력 (`10.40.110.0`)
3. Submit 후 NFS 서비스 활성화 Enable
...
- 정상 마운트 여부 확인
<img width="1140" height="296" alt="image" src="https://github.com/user-attachments/assets/1dbb55c7-8896-4d7a-bdf0-5946158864e0" />
